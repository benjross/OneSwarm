...
public class ReportableErrorDialogBox extends OneSwarmDialogBox {
    ...
    public ReportableErrorDialogBox(final String inErrorString, boolean fatal,
        ...
        String mailto = "mailto:oneswarm@cs.washington.edu?subject=Bug report&body="
                + inErrorString;

        mainPanel.setWidth(WIDTH + "px");

        if (show_reporting) {
            mainPanel.add(new HTML(msg.error_report(mailto)));
        ...
        dismissButton.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                //
                // OneSwarmRPCClient.getService().reportError(inError, new
                // AsyncCallback() {
