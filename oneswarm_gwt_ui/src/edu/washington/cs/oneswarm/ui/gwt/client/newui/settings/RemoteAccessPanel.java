...
class RemoteAccessPanel extends SettingsPanel {
    ...
    RemoteAccessPanel() {
        ...
        enableRemoteAccess = new SettingsCheckBox(msg.settings_net_remote_access_enable(),
                new String[] { OneSwarmConstants.REMOTE_ACCESS_PROPERTIES_KEY });
        ...
        OneSwarmRPCClient.getService().getBooleanParameterValue(OneSwarmRPCClient.getSessionID(),
                OneSwarmConstants.REMOTE_ACCESS_PROPERTIES_KEY, new AsyncCallback<Boolean>() {
        ...
        OneSwarmRPCClient.getService().getRemoteAccessUserName(OneSwarmRPCClient.getSessionID(),
        ...
        OneSwarmRPCClient.getService().getListenAddresses(OneSwarmRPCClient.getSessionID(),
                new AsyncCallback<String[]>() {
                    public void onFailure(Throwable caught) {
                        caught.printStackTrace();
                    }
                    ...
                    public void onSuccess(String[] result) {
                        Label externalLabel = new Label(msg
                                .settings_net_remote_access_address_remote());
                        Label internalLabel = new Label(msg
                                .settings_net_remote_access_address_lan());
                        String external = "https://" + result[0] + "/";
                        String internal = "https://" + result[1] + "/";
                        String externalLink = "<a href='" + external + "' target='_blank'>"
                                + external + "</a>";
                        String internalLink = "<a href='" + internal + "' target='_blank'>"
                                + internal + "</a>";
    ...
    public void sync() {
        ...
        if (enableRemoteAccess.getValue()) {
            ...
            OneSwarmRPCClient.getService().saveRemoteAccessCredentials(
                    OneSwarmRPCClient.getSessionID(), usernameArea.getText(), pw,
                    new AsyncCallback<String>() {
                        public void onFailure(Throwable caught) {
                            caught.printStackTrace();
                        }
    ...
    public class RemoteAccessAdvancedDialog extends OneSwarmDialogBox {
        ...
        RadioButton noLimitButton = new RadioButton("limitGroup",
                msg.settings_net_remote_access_ip_limit_no_limit());
        RadioButton lanButton = new RadioButton("limitGroup",
                msg.settings_net_remote_access_ip_limit_lan_only());
        final RadioButton ipRangeButton = new RadioButton("limitGroup",
                msg.settings_net_remote_access_ip_limit_range_only());
        ...
        public RemoteAccessAdvancedDialog() {
             ...
             */
            OneSwarmRPCClient.getService().getStringParameterValue(
                    OneSwarmRPCClient.getSessionID(),
                    OneSwarmConstants.REMOTE_ACCESS_LIMIT_TYPE_KEY, new AsyncCallback<String>() {
                        public void onFailure(Throwable caught) {
                            caught.printStackTrace();
                            hide();
                        }
            ...
            OneSwarmRPCClient.getService().getStringParameterValue(
                    OneSwarmRPCClient.getSessionID(),
                    OneSwarmConstants.REMOTE_ACCESS_LIMIT_IPS_KEY, new AsyncCallback<String>() {
                        public void onFailure(Throwable caught) {
                            caught.printStackTrace();
                            hide();
                        }
        ...
        public void onClick(ClickEvent event) {
            if (event.getSource().equals(okButton)) {
                ...
                OneSwarmRPCClient.getService().updateRemoteAccessIpFilter(
                        OneSwarmRPCClient.getSessionID(), getSelectedType(), ipRangeBox.getText(),
