...
public class InvitationCreatePanel extends FriendsImportWithBack {
    ...
    public static final String FRIEND_INVITE_NAME_HELP = msg
            .add_friends_invite_create_nickname_help();
    ...
    private class Step1 extends FriendsImportWithBackStep implements KeyUpHandler {
        ...
        public Step1(InvitationCreatePanel parent) {
            ...
            noSecurityButton = new RadioButtonWithHelp("security_buttons",
                    msg.add_friends_invite_create_no_security(), false,
                    msg.add_friends_invite_create_no_security_help_HTML());
            noSecurityButton.setValue(true);
            // this.add(noSecurityButton);

            pinCodeButton = new RadioButtonWithHelp("security_buttons",
                    msg.add_friends_invite_create_pin_security(), false,
                    msg.add_friends_invite_create_pin_security_help_HTML());
            ...
            RadioButtonWithHelp manual = new RadioButtonWithHelp("delivery_group",
                    msg.add_friends_invite_create_delivery_manual(), false,
                    msg.add_friends_invite_create_delivery_manual_help());
            ...
            emailRadioButton = new RadioButtonWithHelp("delivery_group",
                    msg.add_friends_invite_create_delivery_email(), false,
                    msg.add_friends_invite_create_delivery_email_help());
            ...
            deliveryPanel
                    .setCellHorizontalAlignment(emailAdressPanel, HorizontalPanel.ALIGN_CENTER);
        ...
        public FriendsImportWithBackStep createNextPanel() {
            ...
            return new Step2(parent, nickBox.getText(), securityLevel,
                    emailRadioButton.getValue() ? emailTextBox.getText() : null);
        }
    ...
    private class Step2 extends FriendsImportWithBackStep {
        ...
        public Step2(final InvitationCreatePanel parent, final String nickname,
                SecurityLevel securityLevel, final String email) {

            final Label wait = new Label(msg.add_friends_invite_create_generating());
            parent.enableNextButton(false);
            this.add(wait);
            backButton.setVisible(false);
            OneSwarmRPCClient.getService().createInvitation(OneSwarmRPCClient.getSessionID(),
                    nickname, true, MAX_AGE, securityLevel,
                    new AsyncCallback<FriendInvitationLite>() {
                        @Override
                        public void onFailure(Throwable caught) {
                            caught.printStackTrace();
                            new ReportableErrorDialogBox("error: " + caught.getMessage(), false);
                        }
                        ...
                        public void onSuccess(final FriendInvitationLite invite) {
                            ...
                            if (email != null) {
                                OneSwarmRPCClient.getService().getComputerName(
        ...
        private void mailtoImpl(String mailto) {
        ...
        private String buildMailto(String email, String code, String nick) {
            ...
            String mailto = null;
            mailto = "mailto:" + email + "?subject=" + msg.add_friends_invite_email_subject()
                    + "&body=" + URL.encode(getEmailBody(code, nick));
            return mailto;
        }
        ...
        private String getEmailBody(String code, String nick) {
            ...
            text += "\n"
                    + URL.encode(OneSwarmConstants.ONESWARM_DEFAULT_ENTRY_URL + "#"
                            + OneSwarmConstants.FRIEND_INVITE_PREFIX
                            + OneSwarmConstants.FRIEND_INVITE_CODE_PREFIX + code + ":"
                            + OneSwarmConstants.FRIEND_INVITE_NICK_PREFIX + nick);
