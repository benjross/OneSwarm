...
public class SettingsDialog extends OneSwarmDialogBox {
    ...
    public SettingsDialog onInitialize() {
        ...
        DisclosurePanel communityDisclosurePanel = new DisclosurePanel(
                msg.settings_net_community_servers(), true);
        communityDisclosurePanel.add(communityPanel);
        networkTab.add(communityDisclosurePanel);

        DisclosurePanel filterDisclosurePanel = new DisclosurePanel(
                msg.settings_net_search_filter(), false);
        filterDisclosurePanel.add(filterPanel);
        networkTab.add(filterDisclosurePanel);

        if (OneSwarmGWT.isRemoteAccess() == false) {
            DisclosurePanel remoteAccessDisclosurePanel = new DisclosurePanel(
                    msg.settings_net_remote_access(), true);
        ...
        DisclosurePanel tagsDisclosurePanel = new DisclosurePanel(msg.settings_interface_tags(),
                true);
