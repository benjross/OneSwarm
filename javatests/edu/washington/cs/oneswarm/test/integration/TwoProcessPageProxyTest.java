...
public class TwoProcessPageProxyTest extends TwoProcessTestBase {
    ...
    private static Logger logger = Logger.getLogger(TwoProcessPageProxyTest.class.getName());
    ...
    public void testProxyFunctionality() throws InterruptedException {
        ...
        try {
            ...
            localOneSwarm.getCoordinator().addCommand(
                    "expose_client proxyclient " + SEARCH_KEY + " " + CLIENT_PORT);
            Thread.sleep(5000);
    ...
    private void tellLocalToShareService(long searchKey, int port) throws InterruptedException {
        ServiceSharingManager.getInstance().registerSharedService(searchKey, "socks",
                new InetSocketAddress(LOCALHOST, port));
        ProxyServer proxyServer = new ProxyServer(port);
        proxyServer.startDeamonThread(true);
    }
    ...
    public static void main(String[] args) throws Exception {
        TestUtils.swtCompatibleTestRunner(TwoProcessPageProxyTest.class);
    }
}
